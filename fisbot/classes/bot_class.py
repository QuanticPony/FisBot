...
class FisBot(commands.Bot):
    ...
    async def add_extension(self, extension_name):
    ...
    async def del_extension(self, extension_name):
    ...
    async def del_extensions(self, extensions_names):
        ...
        '''
        for extenion_name in extensions_names:
            await self.unload_extension(extenion_name)